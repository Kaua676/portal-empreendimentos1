...
$carteira = $dadosboleto["carteira"] ? $dadosboleto["carteira"]:"00";  //editado por krysten
...
function fator_vencimento($data) {
  ...
  $dia = isset($data[0]) && is_numeric($data[0]) ? $data[0] : 0;
  $mes = isset($data[1]) && is_numeric($data[1]) ? $data[1] : 0;
  $ano = isset($data[2]) && is_numeric($data[2]) ? $data[2] : 0;
